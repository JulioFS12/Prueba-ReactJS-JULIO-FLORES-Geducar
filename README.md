...
1. ``` git clone https://github.com/JulioFS12/Prueba-ReactJS-JULIO-FLORES-Geducar.git```
2. ``` npm install ``` It's recommend using sass ```version V-4.14.1```.
3. ``` npm start ```.
4. ```npm deploy``` to host at github pages. 
